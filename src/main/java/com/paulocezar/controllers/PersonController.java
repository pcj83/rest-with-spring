...
import com.paulocezar.services.PersonServices;

import io.swagger.annotations.Api;
import io.swagger.annotations.ApiOperation;

//@CrossOrigin
@Api(value = "Person API", description = "Description for person", tags = {"Person Endpoint"})
@RestController
...
public class PersonController {
	...
	public ResponseEntity<PagedResources<PersonVO>> findAll(
		...
		Object sorteDirection =  "desc".equalsIgnoreCase(direction)? (Direction) Direction.DESC: Direction.ASC;
		
		Pageable pageable = PageRequest.of(page, limit, Sort.by((Direction)sorteDirection,"firstName"));
	...
	//CrossOrigin(origins= {"http:localhost:8080"},{"www.i9sites.com"})
